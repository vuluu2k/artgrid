...
export default function MenuAdmin() {
    ...
    return (
        <>
            <div style={{width: '25%', height: '500vh',backgroundColor:'#0f1a55',position:'fixed'}}>
                ...
                <div>
                    <div className="d-flex flex-column  text-white" style={{padding:'0 10% 0 10%'}}>
                            ...
                            <Link to='/admin/silder' className='font-link-menu'>
                                <div className="color-container d-flex align-items-center">
                                    <div className="icon_center" style={{paddingLeft:'5%'}}>
                                        ...
                                        <span className="icon_span" style={{paddingLeft:'3px',fontSize:'18px',fontWeight:'bolder'}}>Quản lý Slide</span>
                                    </div>
                                </div>
                            </Link>
                        </div>
                        ...
                        <div>
                            <Button onClick={displayConfirm} className='font-link-menu' style={{width:'100%',padding:'0',borderRadius:'10px',backgroundColor:'#ff0000',border:'none'}}>
                                <div className="color-container d-flex align-items-center">
                                    <div className="icon_center" style={{paddingLeft:'5%'}}>
